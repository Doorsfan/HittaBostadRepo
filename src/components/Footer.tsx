        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Premium athletic footwear for those who demand the best in performance and style.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">New Arrivals</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">Running</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">Basketball</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">Training</a></li>
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">Sale</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-orange-400 transition-colors">Size Guide</a></li>
          ...
          <div>
            ...
            <form className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg font-medium hover:from-orange-600 hover:to-red-600 transition-colors"
              >
                Join
              </button>
            </form>
